...
![photo](./images/mainboard.jpg)  
I bought this board a while ago missing it's proprietary memory board with the plan to reverse engineer the memory board.  
The board was designed with sipp memory in mind as i have a lot of sipp modules, but the spacing also allows for simm sockets to be installed.
